...
from pynumber import ZERO, Integer, Rational, create_integer_from_int


def test_new() -> None:
    """Test new"""
    Rational(Integer(ZERO, ZERO), Integer(ZERO.successor, ZERO))
    with pytest.raises(ValueError):
        _ = Rational(Integer(ZERO, ZERO), Integer(ZERO, ZERO))
